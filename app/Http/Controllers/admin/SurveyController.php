...
class SurveyController extends Controller
{
    ...
    {
        $lastsignboard = Survey::orderBy('created_at', 'desc')->pluck('signboard')->first();
        $showcase = Survey::orderBy('created_at', 'desc')->pluck('showcase')->first();
        $ldu_table = Survey::orderBy('created_at', 'desc')->pluck('ldu_table')->first();
        $promoter = Survey::orderBy('created_at', 'desc')->pluck('signboard')->first();
        $cabinet = Survey::orderBy('created_at', 'desc')->pluck('signboard')->first();
        $promotion_stand = Survey::orderBy('created_at', 'desc')->pluck('signboard')->first();
