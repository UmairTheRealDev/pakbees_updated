...
@section('content')
    <main class="content">
        <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-6">
                    <h1 class="h3 mb-3">Edit Survey</h1>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.survey.update', $survey) }}" method="POST">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="model" id="model"
                                            ...
                                            @else
                                                <option value="" selected>Select a model!</option>
                                                @foreach ($models as $model)
                                                    @if ($model->brand_id == $survey->brand_id)
                                                        @if ($model->id == $survey->device_model_id)
                                                            <option value="{{ $model->id }}" selected>
                                                                {{ $model->name }}
                                                            </option>
                                                        @else
                                ...
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('signboard') ?? $survey->signboard }}">
                                        @error('signboard')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        value="{{ old('showcase') ?? $survey->showcase }}">
                                        @error('showcase')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('ldu_table') ?? $survey->ldu_table }}">
                                        @error('ldu_table')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('ldu_qty') ?? $survey->ldu_qty }}">
                                        @error('ldu_qty')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('promoter') ?? $survey->promoter }}">
                                        @error('promoter')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('cabinet') is-invalid @enderror"
                                            ...
                                            value="{{ old('cabinet') ?? $survey->cabinet }}">
                                        @error('cabinet')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('promotion_stand') ?? $survey->promotion_stand }}">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('foc_soh') is-invalid @enderror"
                                            ...
                                            value="{{ old('foc_soh') ?? $survey->foc_soh }}">
                                        @error('foc_soh')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('sell_through') ?? $survey->sell_through }}">
                                        @error('sell_through')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('sell_out') is-invalid @enderror"
                                            ...
                                            value="{{ old('sell_out') ?? $survey->sell_out }}">
                                        @error('sell_out')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('stock_on_hand') ?? $survey->stock_on_hand }}">
                                        @error('stock_on_hand')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="feedback" id="feedback" rows="3" class="form-control @error('feedback') is-invalid @enderror"
                                        placeholder="Enter the feedback!">{{ old('feedback') ?? $survey->feedback }}</textarea>
                                    @error('feedback')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
